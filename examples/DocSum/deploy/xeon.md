...
Intel® Xeon® Scalable processors. We will go through how to setup docker containers to start 
...
You can upload documents(.txt,.doc,.pdf), audio and video and get the summarization of the content.

::::::{tab-set}
:::::{tab-item} Text
:sync: Text

The megaservice accepts intput files in txt, pdf, doc format or a plain text in the message parameter.
```bash
