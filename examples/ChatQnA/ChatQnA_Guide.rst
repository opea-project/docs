...
To get a preview of the ChatQnA example, you visit the `AI Explore page <https://aiexplorer.intel.com/explore>`_. The **ChatQnA Solution** provides a basic chatbot while the **ChatQnA with Augmented Context** allows you to upload your own files in order to quickly experiment with a RAG solution to see how a developer supplied corpus can provide relevant and up to date responses.
