...
# GenAIInfra 
-GMC
    - Enable gmc e2e for manifests changes and some minor fix ([758432](https://github.com/opea-project/GenAIInfra/commit/758432301ed9811a24a3f1118be629f670af863e))
    - GMC: make "namespace" field of each resource in the CR optional ([7073ac](https://github.com/opea-project/GenAIInfra/commit/7073acfcc22b9a0aef6bd1e079f079804083f7ff))
    - ChatQnA demo yaml files integration between GMC and Oneclick ([020899](https://github.com/opea-project/GenAIInfra/commit/020899807b3690e9e1efced4c506866a736b9b1b))
    - Add gmc e2e ([595185](https://github.com/opea-project/GenAIInfra/commit/59518512cb836d8b30638dba6275b9fbdf0b055a))
    - Add docker build and push target for GMC ([04d7f2](https://github.com/opea-project/GenAIInfra/commit/04d7f24e0f529b31e834a38dd68797a3151be4a7))
    - GMC: overwrite config map template before GMC resources are deployed ([ce9190](https://github.com/opea-project/GenAIInfra/commit/ce919006acf577907f01aa66fa22a6a91ed84fa7))
    - GMC: replace the service and deployment name if GMC has defined ([eec845](https://github.com/opea-project/GenAIInfra/commit/eec8452520daef3475dd5038e5fffc6a84a3a9a1))
    - Add gmc guide ([6bb8a3](https://github.com/opea-project/GenAIInfra/commit/6bb8a3391524832307c05571b19f2a77e9e677ba))
    - GMC: adopt separate e2e for gaudi and xeon ([c5075b](https://github.com/opea-project/GenAIInfra/commit/c5075b20a4e750c51d8289937f4bb97302f53a8e))
    - Update readme and user guide for GMC ([2d17c9](https://github.com/opea-project/GenAIInfra/commit/2d17c901ae5122e8476ff7887b85b315edd3a04c))
    - GMC: add Codetrans example ([aed70d](https://github.com/opea-project/GenAIInfra/commit/aed70da61e6b9ef7afbb2502e14637b3baf3ff6a))
    - Enable GMC e2e on Gaudi ([d204a7](https://github.com/opea-project/GenAIInfra/commit/d204a77922c1fd19db7f5e5b6cf0e0c2b3d8c400))
