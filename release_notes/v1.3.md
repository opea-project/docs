...
We are excited to announce the release of OPEA version 1.3, which includes significant contributions from the open-source community. This release addresses over 440 pull requests.
...
<!-- - add 'N/A' to option (#1801) (72ce335) -->
...
<!-- - kubeai: README update (#976) (e4c2649) -->
</details>
...
The following Docker images are deprecated and will be removed since OPEA v1.4:
| Deprecated Docker Image | Migration Solution | Reasons for Deprecation |
|--|--|--|
