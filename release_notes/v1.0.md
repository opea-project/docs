...
- Community
    - Improve code and CI/CD structure for partners, vendors, and contributors
    - Expand support for additional model hubs, including ModelScope

- Broaden functionality
    - Add fine-tuning examples: InstructionTuning and RerankFinetuning, with InstructionTuning also supporting Pre-training
    - Introduce MMRAG examples: VideoRAGQnA and MultimodalRAGWithVideos
    - Provide GraphRAG based on Neo4j
    - Add support for Feedback Management and Intent Detection microservices

- Enhancement
    - Release benchmarking data and related manifests
    - Enable P90, P99, and average latency metrics for first token, next token, and end-to-end latency in benchmark
    - Added accuracy evaluations for AudioQnA, CodeGen, FAQGen, ...etc
    - Provide a guide for setting up observability for OPEA workloads in Kubernetes environments

- Deployment 
    - Add support for HorizontalPodAutoscaler (HPA)
...
- Thanks for the external contribution from [andreeamun](https://github.com/andreeamun), [Sharan Shirodkar](https://github.com/sharanshirodkar7), [berkecanrizai](https://github.com/berkecanrizai), and [jotpalch](https://github.com/jotpalch)
