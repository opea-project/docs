...
We are excited to announce the release of OPEA version 1.2, which includes significant contributions from the open-source community. This release addresses over 290 pull requests.
...
#### Newly Supported Hardware (TODO: finalize the list after code freeze)
- Intel® Gaudi® 3 AI Accelerator
- AMD® GPU using AMD® ROCm™ for [AgentQnA](https://github.com/opea-project/GenAIExamples/pull/1166), [AudioQnA](https://github.com/opea-project/GenAIExamples/pull/1147), [MultimodalQnA](https://github.com/opea-project/GenAIExamples/pull/1233), [VisualQnA](https://github.com/opea-project/GenAIExamples/pull/1201), [SearchQnA?](https://github.com/opea-project/GenAIExamples/pull/1193), [Translation](https://github.com/opea-project/GenAIExamples/pull/1191).
...
#### Movements
- Move `redis`, `milvus`, `elasticsearch`, `opensearch`, ``
...
- Rename [opea/embedding-multimodal-bridgetower-gaudi](https://hub.docker.com/r/opea/embedding-multimodal-bridgetower-gaudi) to `opea/embedding-multimodal-bridgetower-hpu`. <!--[opea/embedding-multimodal-bridgetower-hpu](https://hub.docker.com/r/opea/embedding-multimodal-bridgetower-hpu)-->
