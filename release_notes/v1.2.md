...
- <b>Model Context Protocol(MCP) Support</b>: Experimental support for [MCP at Retriever](https://github.com/opea-project/GenAIComps/pull/1155).
...
#### Newly Supported Hardware (TODO: finalize the list when code freeze)
