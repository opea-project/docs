...
- <b>OPEA Store</b>: Enhanced data access using OPEA Store for ChatHistory, FeedbackManagement, and PromptRegistry. ([GenAIComps#1916](https://github.com/opea-project/GenAIComps/pull/1916)) 
